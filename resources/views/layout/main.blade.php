                ...
                <div class="drawer-side z-50">
                    ...
                    <ul class="menu p-4 w-80 min-h-full bg-base-200 text-base-content">
                        ...
                        <li><a href="">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center"><svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                                            <path class="fill-current text-accent" d="M8.07 16H10V8H8.07a8 8 0 110 8z">
                                            </path>
                                            <path class="fill-current text-indigo-400" d="M15 12L8 6v5H0v2h8v5z">
                                            </path>
                                        </svg><span
                                            class="text-sm  font-medium ml-3 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Logout</span>
                                    </div>
                                </div>
                            </a></li>
                    </ul>
